...
PKG_SOURCES	=  tclsnappy.c snappy.cc snappy-sinksource.cc snappy-stubs-internal.cc snappy-c.cc
PKG_OBJECTS	=  tclsnappy.o snappy.o snappy-sinksource.o snappy-stubs-internal.o snappy-c.o
...
PKG_LIB_FILE	= libsnappy0.11.so
PKG_LIB_FILE8	= libsnappy0.11.so
PKG_LIB_FILE9	= libtcl9snappy0.11.so
PKG_STUB_LIB_FILE = libsnappystub0.11.a
...
top_builddir	= /home/danilo/Public/tcl.snappy
...
# compiled with.
#DEFS		= $(TCL_DEFS) -DPACKAGE_NAME=\"snappy\" -DPACKAGE_TARNAME=\"snappy\" -DPACKAGE_VERSION=\"0.11\" -DPACKAGE_STRING=\"snappy\ 0.11\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DBUILD_snappy=/\*\*/ -DHAVE_STDIO_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_STRINGS_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_UNISTD_H=1 -DSTDC_HEADERS=1 -DTcl_Size=int -DUSE_THREAD_ALLOC=1 -D_REENTRANT=1 -D_THREAD_SAFE=1 -DUSE_TCL_STUBS=1 -DUSE_TCLOO_STUBS=1 -DMODULE_SCOPE=extern\ __attribute__\(\(__visibility__\(\"hidden\"\)\)\) -DHAVE_HIDDEN=1 -DHAVE_STDBOOL_H=1 -DTCL_WIDE_INT_IS_LONG=1 -DTCL_CFG_OPTIMIZED=1 -DTCL_MAJOR_VERSION=8 $(PKG_CFLAGS)
DEFS		= -DPACKAGE_NAME=\"snappy\" -DPACKAGE_TARNAME=\"snappy\" -DPACKAGE_VERSION=\"0.11\" -DPACKAGE_STRING=\"snappy\ 0.11\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DBUILD_snappy=/\*\*/ -DHAVE_STDIO_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_STRINGS_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_UNISTD_H=1 -DSTDC_HEADERS=1 -DTcl_Size=int -DUSE_THREAD_ALLOC=1 -D_REENTRANT=1 -D_THREAD_SAFE=1 -DUSE_TCL_STUBS=1 -DUSE_TCLOO_STUBS=1 -DMODULE_SCOPE=extern\ __attribute__\(\(__visibility__\(\"hidden\"\)\)\) -DHAVE_HIDDEN=1 -DHAVE_STDBOOL_H=1 -DTCL_WIDE_INT_IS_LONG=1 -DTCL_CFG_OPTIMIZED=1 -DTCL_MAJOR_VERSION=8 $(PKG_CFLAGS)
